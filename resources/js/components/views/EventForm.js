        ...
        <div className="container mt-4 mb-5">
          <Form>
            <Form.Group controlId="createForm.ControlInput1">
              ...
              <Form.Control type="text" style={{ width: '100%', marginBottom: '0.5rem', background: "#D6E5E3",border:"solid 1.50px #40C0DD" }} defaultValue={this.props.package ? this.props.package.event_title : ''} onChange={this.props.onChangeName}/>
            </Form.Group>
            ...
            <Form.Group controlId="createForm.ControlInput7">
              <Form.Label>Image of the event:</Form.Label>
              <Form.Control style={{ width: '100%', marginBottom: '0.5rem', background: "#D6E5E3",border:"solid 1.50px #40C0DD" }} type="text" defaultValue={this.props.package ? this.props.package.event_image: ''} onChange={this.props.onChangeImage}/>
            </Form.Group>
            <Form.Group controlId="createForm.ControlInput8">
              <Form.Label>Video of the event:</Form.Label>
              <Form.Control style={{ width: '100%', marginBottom: '0.5rem', background: "#D6E5E3",border:"solid 1.50px #40C0DD" }} type="text" defaultValue={this.props.package ? this.props.package.event_video: ''} onChange={this.props.onChangeVideo}/>
            </Form.Group>
